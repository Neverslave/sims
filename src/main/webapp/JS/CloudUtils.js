...
//    };
  window.onload = function(){
	  $('#setIndex', window.parent.document).hide();
//	  $("input").placeholder();
  }
...
//		var ss= data2string.replace(/[\s\S]*"menuId"/g,'JH');
	 ...
	 * 得到多少天后的日期
	 */
	CloudUtils.addDays = function(strDate, days) {
	...
	CloudUtils.getMenuNames = function(id){
		...
		var nav ='<ol id="breadcrumb" class="breadcrumb">您的位置：';
	 ...
	 * radix：基数
	 */
	CloudUtils.getUUID=function(len, radix){
